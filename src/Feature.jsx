    ...
    <main>
      ...
      >
        ...
        <div className="relative lg:flex lg:mt-[16rem] lg:bg-veryDarkGrayBlue lg:rounded-bl-[6rem] lg:rounded-tr-[6rem]">
          <div className="absolute w-full top-[5.1rem] h-[23rem] lg:top-0 lg:relative lg:basis-[50%] lg:bg-pattern-circle lg:bg-no-repeat lg:bg-[position:center_-500px] lg:h-auto">
            <img
